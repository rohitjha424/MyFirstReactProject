    ...
    return (
        <div class = "card-wrapper mr-5 mt-5">
            ...
            <div class = "task-holder" >
                <span class = "card-header" style={{"background-color": colors[index%5].secondaryColor, "border-radius": "3px"}}>{taskObj.Name}</span>
                <p className = "mt-3 txt-wp">{taskObj.Description}</p>
